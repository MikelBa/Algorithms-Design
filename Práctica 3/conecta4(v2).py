...
###############################EVALUACIÓN###############################
###A las siguientes funciones les damos el nodo actual y la posición de partida (i,j) y
##devuelven 1 si desde esa posición hay un numero n (n=linea) seguido de fichas del mismo color, sino devuelve 0.
...
def evaluar(nodo):
###Esta función evalua el nodo. Para evaluar el nodo cuenta las lineas de dos, tres y cuatro que tiene cada
###jugador y devuelve el valor de el nodo de esta manera:
###     Si el ordenador tiene un 4 en raya: 999999
###     Si el oponente tiene un 4 en raya:  999999
###     Si nadie tiene un 4 en raya: 100*(3 en rayas de x)+(2 en rayas de x)-100*(3 en rayas de o)-(3 en rayas de o)
    cont2_o=0
    cont2_x=0
    cont3_o=0
    cont3_x=0
